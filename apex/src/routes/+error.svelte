...
<section class="flex items-center h-screen p-16 bg-gray-100 text-gray-800">
    <div class="container flex flex-col items-center justify-center px-5 mx-auto my-8">
        <div class="max-w-md text-center">
            ...
            <a href="/" class="px-8 py-3 font-semibold rounded bg-orange-600 text-white hover:bg-orange-700">Back to homepage</a>
        </div>
    </div>
</section>